// --------------------------------------------------------------------------------------------------------------------
// <copyright company="MirGames" file="NotificationsAddedEvent.cs">
...
namespace MirGames.Domain.Notifications.Events
{
    ...
    public sealed class NotificationsAddedEvent : Event
    {
        /// <summary>
        ...
        {
            get { return "Notifications.NotificationsAdded"; }
        }
    }
}
