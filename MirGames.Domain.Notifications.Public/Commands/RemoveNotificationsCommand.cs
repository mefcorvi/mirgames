// --------------------------------------------------------------------------------------------------------------------
// <copyright company="MirGames" file="RemoveNotificationsCommand.cs">
...
namespace MirGames.Domain.Notifications.Commands
{
    ...
    public sealed class RemoveNotificationsCommand : Command<int>
    {
        ...
        /// </summary>
        public string[] NotificationIdentifiers { get; set; }
        ...
        public RemoveNotificationsCommand WithFilter<T>() where T : NotificationData, new()
        {
            var instance = new T();
        ...
        /// <returns>The query.</returns>
        public RemoveNotificationsCommand WithFilter<T>(Expression<Func<T, bool>> filter) where T : NotificationData, new()
        {
            var instance = new T();
            this.NotificationType = instance.NotificationType;
