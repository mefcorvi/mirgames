...
namespace Xilium.MarkdownDeep
{
    ...
    public class LinkDefinition
    {
        ...
        /// <param name="alt_text">The alt_text.</param>
        internal void RenderMedia(Markdown m, StringBuilder b, string alt_text)
        {
            var video = OEmbedProviders.GetObject<Video>(this.url);
            ...
            var image = OEmbedProviders.GetObject<Photo>(this.url);
        ...
        /// <param name="b">The attribute.</param>
        /// <param name="alt_text">The alt_text.</param>
        private void RenderImage(Markdown m, StringBuilder b, string alt_text)
        {
