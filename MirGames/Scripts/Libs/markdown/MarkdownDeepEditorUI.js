...
var MarkdownDeepEditorUI = new function () {
    ...
    this.HelpHtml = function(help_location) {
        ...
        str += '<a href="javascript:void(0);" id="mdd_close_help">Close</a>\n';
        str += '</div>\n';
    ...
    this.ToolbarHtml = function() {
        ...
        //str += '<a href="javascript:void(0);" class="mdd_help" tabindex="-1" title="Справка по Markdown"><i class="fa fa-question-circle"></i></a>\n';
        str += '</div>\n';
        str += '<ul>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_undo" title="Отменить (Ctrl+Z)" tabindex=-1><i class="fa fa-reply"></i></a></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_redo" title="Повторить (Ctrl+Y)" tabindex=-1><i class="fa fa-share"></i></a></li>\n';
        str += '<li><span class="mdd_sep"></span></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_heading" title="Заголовок (Ctrl+H, or Ctrl+0 to Ctrl+6)" tabindex=-1><i class="fa fa-text-height"></i></a></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_code" title="Код (Ctrl+K or Tab/Shift+Tab on multiline selection)" tabindex=-1><i class="fa fa-code"></i></a></li>\n';
        str += '<li><span class="mdd_sep"></span></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_bold" title="Полужирный (Ctrl+B)" tabindex=-1><i class="fa fa-bold"></i></a></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_italic" title="Курсив (Ctrl+I)" tabindex=-1><i class="fa fa-italic"></i></a></li>\n';
        str += '<li><span class="mdd_sep"></span></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_ullist" title="Неупорядоченный список (Ctrl+U)" tabindex=-1><i class="fa fa-list-ul"></i></a></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_ollist" title="Упорядоченный список (Ctrl+O)" tabindex=-1><i class="fa fa-list-ol"></i></a></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_outdent" title="Отменить цитирование (Ctrl+W)" tabindex=-1><s><i class="fa fa-ban"></i></s></a></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_indent" title="Цитировать (Ctrl+Q)" tabindex=-1><i class="fa fa-quote-left"></i></a></li>\n';
        str += '<li><span class="mdd_sep"></span></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_link" title="Вставить ссылку (Ctrl+L)" tabindex=-1><i class="fa fa-chain"></i></a></li>\n';
        str += '<li><a href="javascript:void(0);" class="mdd_button" id="mdd_img" title="Вставить картинку (Ctrl+G)" tabindex=-1><i class="fa fa-picture-o"></i></a></li>\n';
    ...
    this.onToolbarButton = function(e) {
        ...
        var editor = $(e.currentTarget).closest("div.mdd_toolbar_wrap").nextAll('.mdd_editor_wrap').children("textarea").data("mdd");
        editor.InvokeCommand(id.substr(4));
    ...
    $.fn.MarkdownDeep = function (options) {
        ...
        return this.each(function () {
            ...
            if (settings.toolbar) {
                ...
                var toolbarwrap = $('.mdd_toolbar_wrap', editorwrap.parent()),
                    toolbar = $('.mdd_toolbar', editorwrap.parent());
