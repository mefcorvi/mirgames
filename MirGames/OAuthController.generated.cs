...
namespace MirGames.Controllers
{
    public partial class OAuthController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult Authorize()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Authorize);
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_OAuthController : MirGames.Controllers.OAuthController
    {
        ...
        [NonAction]
        partial void AuthorizeOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string provider);

        [NonAction]
        public override System.Web.Mvc.ActionResult Authorize(string provider)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Authorize);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "provider", provider);
            AuthorizeOverride(callInfo, provider);
            return callInfo;
        }
