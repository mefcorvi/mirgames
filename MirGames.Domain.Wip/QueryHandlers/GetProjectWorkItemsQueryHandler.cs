            ...
            PaginationSettings pagination)
        {
            ...
            var workItemViewModels = workItems
                .Select(x => new ProjectWorkItemViewModel
                {
                    ...
                    Description = this.textProcessor.GetHtml(x.Description),
                    ...
                    AssignedTo = new AuthorViewModel { Id = x.AssignedTo },
                    Duration = x.Duration,
                    EndDate = x.EndDate,
                    ParentId = x.ParentId,
            ...
            {
                Authors = workItemViewModels.Select(x => x.Author).Concat(workItemViewModels.Select(x => x.AssignedTo))
            });
