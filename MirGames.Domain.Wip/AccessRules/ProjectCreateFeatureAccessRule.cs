// --------------------------------------------------------------------------------------------------------------------
// <copyright company="MirGames" file="ProjectCreateFeatureAccessRule.cs">
...
namespace MirGames.Domain.Wip.AccessRules
{
    ...
    internal sealed class ProjectCreateFeatureAccessRule : AccessRule<Project>
    {
        protected override string Action
        {
            get { return "CreateFeature"; }
        }
