// --------------------------------------------------------------------------------------------------------------------
// <copyright company="MirGames" file="DeleteCommentCommandHandler.cs">
...
namespace MirGames.Domain.Topics.CommandHandlers
{
    ...
    internal sealed class DeleteCommentCommandHandler : CommandHandler<DeleteCommentCommand>
    {
        ...
        /// <inheritdoc />
        protected override void Execute(DeleteCommentCommand command, ClaimsPrincipal principal, IAuthorizationManager authorizationManager)
        {
